package org.shaneking.skava.persistence;
...
public class Tuple<First, Rest> implements Iterable<Object> {
  ...
  public static class DecuplePlus<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, Tuple<T6, Tuple<T7, Tuple<T8, Tuple<T9, Tuple<T10, Tuple<Object[], End>>>>>>>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Iterables.concat(Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first, rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.rest.rest.first), Lists.newArrayList(rest.rest.rest.rest.rest.rest.rest.rest.rest.rest.first)).iterator();
    }
  }
  ...
  public static class Decuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, Tuple<T6, Tuple<T7, Tuple<T8, Tuple<T9, Tuple<T10, End>>>>>>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first, rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Nonuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, Tuple<T6, Tuple<T7, Tuple<T8, Tuple<T9, End>>>>>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first, rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Octuple<T1, T2, T3, T4, T5, T6, T7, T8> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, Tuple<T6, Tuple<T7, Tuple<T8, End>>>>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first, rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Septuple<T1, T2, T3, T4, T5, T6, T7> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, Tuple<T6, Tuple<T7, End>>>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first, rest.rest.rest.rest.rest.first, rest.rest.rest.rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Sextuple<T1, T2, T3, T4, T5, T6> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, Tuple<T6, End>>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first, rest.rest.rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Quintuple<T1, T2, T3, T4, T5> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, Tuple<T5, End>>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first, rest.rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Quadruple<T1, T2, T3, T4> extends Tuple<T1, Tuple<T2, Tuple<T3, Tuple<T4, End>>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first, rest.rest.rest.first).iterator();
    }
  }
  ...
  public static class Triple<T1, T2, T3> extends Tuple<T1, Tuple<T2, Tuple<T3, End>>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first, rest.rest.first).iterator();
    }
  }
  ...
  public static class Pair<T1, T2> extends Tuple<T1, Tuple<T2, End>> {
    ...
    @Override
    public Iterator<Object> iterator() {
      return Lists.newArrayList(first, rest.first).iterator();
    }
  }
